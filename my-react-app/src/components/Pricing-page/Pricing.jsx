               ...
               <section className="text-gray-600 body-font overflow-hidden">
                    <div className="container px-5 py-0 mx-auto">
                         <div className="flex flex-col text-center w-full mb-20">
                              <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">Below choose your plan to buy Course</h1>
                              <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Here we are displaying the pricing information to buy your course according to amount so, view it..</p>
